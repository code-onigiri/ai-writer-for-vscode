...
- [x] 2.2 Generation Orchestratorでセッション管理を実装する
...
- [x] 2.3 Template Registryでテンプレートと遵守記録を管理する
...
- [x] 2.4 Persona Managerでパーソナライゼーション適用を制御する
...
- [x] 3.1 AISDK Hubのレジストリと共通インターフェースを整える
...
- [x] 3.2 OpenAI・Gemini APIチャネルを登録する
